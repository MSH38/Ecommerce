						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								<div class="dropdown-menu">
									...
									<ul class="" role="menu">
										<li class="dropdown-item" href=""><i class="bx bx-user-circle"></i>Profile</li>
										<li class="dropdown-item" href=""><i class="bx bx-cog"></i> Edit Profile</li>
										<li class="dropdown-item" href=""><i class="bx bxs-inbox"></i>Inbox</li>
										<li class="dropdown-item" href=""><i class="bx bx-envelope"></i>Messages</li>
										<li class="dropdown-item" href=""><i class="bx bx-slider-alt"></i> Account Settings</li>
									...
									<a class="dropdown-item" href=""><i class="bx bx-slider-alt"></i> Account Settings</a> -->
										<!-- Authentication -->
									<!-- <a class="dropdown-item" href=""><x-dropdown-link :href="route('logout')"
													onclick="event.preventDefault();
