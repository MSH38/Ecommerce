...
@endsection
@section('content')
<form action="{{ url('admin/category') }}" method="POST" enctype="multipart/form-data" style="direction: ltr;">
    @csrf
    ...
    <div class="input-group mb-3">
        ...
        <textarea name="Meta_keyword" class="form-control" cols="30" rows="1"></textarea>
    </div>
    <div class="input-group mb-3">
    ...
    <div class="form-check form-switch mb-2 d-flex justify-content-start">
